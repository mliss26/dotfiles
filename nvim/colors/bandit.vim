...
let ColourAssignment['PreProc']         = {"GUIFG": '#3030FF',     "GUI":     'Bold',      "TERM":  'Underline'}
let ColourAssignment['Include']         = {"GUIFG": '#3030FF',     "GUI":     'Bold'} " preprocessor #include
...
let ColourAssignment['Statement']       = {"GUIFG": '#3434FF',     "TERM":    'Bold'}
...
let ColourAssignment['Label']           = {"GUIFG": '#2828FF'} " case, default, etc.
...
let ColourAssignment['Class']           = {"GUIFG": '#DD9070',     "TERM":  'Underline'}
...
let ColourAssignment['GlobalVariable']  = {"GUIFG": '#888800',     "CTERMFG": 'Cyan',      "TERM":  'Underline'}
...
let ColourAssignment['SpecialKey']      = {"GUIFG": '#777777'}     " special highlighting for 'listchars' etc
let ColourAssignment['NonText']         = {"GUIFG": '#777777'}     " special highlighting for 'listchars' etc
...
" Text Titles
let ColourAssignment['Title']           = {"GUIFG": '#3030FF',        "GUI": "Bold"}
let ColourAssignment['htmlH1']          = {"GUIFG": '#3030FF'}
...
let ColourAssignment['EasyMotionTarget'] = {"GUIFG": 'red',			"GUIBG": '#333333'}
let ColourAssignment['gcovExecuted']    = {"GUIFG": 'darkgreen'}
let ColourAssignment['gcovNotExecuted'] = {"GUIFG": 'red'}
let ColourAssignment['gcovNoCode']	    = {"GUIFG": 'grey'}
